...
from random_walk.rw_models import ProximityWalker
...
# Execute random walk bootstrapping
walker = ProximityWalker(graph, q_0=0.5)
graph = walker.walk(N_RANDOM_WALKS)
